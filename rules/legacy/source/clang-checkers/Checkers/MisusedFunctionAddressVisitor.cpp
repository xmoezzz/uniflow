...
#if RELEASE_BUNDLE
void ento::registerMisusedFunctionAddressVisitor(CheckerManager& Mgr) {
	Mgr.registerChecker<MisusedFunctionAddressVisitor>();
}

bool ento::shouldRegisterMisusedFunctionAddressVisitor(const CheckerManager& mgr) {
